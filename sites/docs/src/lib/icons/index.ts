...
export { default as HardDrives } from "phosphor-svelte/lib/HardDrives";
export { default as PaintRoller } from "phosphor-svelte/lib/PaintRoller";
export { default as BracketsCurly } from "phosphor-svelte/lib/BracketsCurly";
export { default as Laptop } from "phosphor-svelte/lib/Laptop";
export { default as Browser } from "phosphor-svelte/lib/Browser";
